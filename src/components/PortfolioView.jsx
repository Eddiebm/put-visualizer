...
import { money, moneySigned, trimNum } from "../lib/format.js";
import { legLabel } from "../lib/pnl.js";
import { entryCollateral, entryRiskNote, entryBadWeekPnl } from "../lib/journal.js";
import { entryDaysTo } from "../lib/dates.js";
...
export function PortfolioView({ journal, dropPct, onOpenJournal }) {
