import { money, money2, trimNum, num } from "../lib/format.js";
import { stratPnl } from "../lib/pnl.js";
import { COMPANIES } from "../appConstants.js";
import { styles } from "../styles.js";

export function buildTourSteps(ticker, inputs, model) {
...
export function Tour({ step, steps, onNext, onDone, onSkip }) {
