...
import { targetExpiration } from "../lib/dates.js";
import { analyzeStock, stockChecks, technicalMarketCondition } from "../lib/technicals.js";
...
export function AlexScan({ capital, onLoad }) {
