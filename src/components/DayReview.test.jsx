...
import { DayReview } from "./DayReview.jsx";
...
describe("DayReview", () => {
  ...
  it("counts a trade opened today, and shows today's realized P&L", () => {
    const journal = [
      { id: "1", openedAt: today(), status: "closed", closedAt: today(), realizedPnl: 200, mode: "put", putStrike: 50, contracts: 1 },
    ];
  ...
  it("does not count a trade opened on a different day as today's", () => {
    const journal = [
      { id: "1", openedAt: "2020-01-01", status: "open", mode: "put", putStrike: 50, contracts: 1 },
    ];
