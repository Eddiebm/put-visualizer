...
import { roundStrike, round2, spreadWidthFor, stratPnl, legLabel, buildModel, assignmentSummary } from "./pnl";
...
describe("stratPnl — cash-secured put", () => {
  const p: StrategyParams = { mode: "put", putStrike: 50, putPrem: 2, shares: 100 };
...
describe("stratPnl — put credit spread", () => {
  ...
  const p: StrategyParams = { mode: "spread", putStrike: 50, putPrem: 2, longStrike: 45, longPrem: 1, shares: 100 };
...
describe("stratPnl — short strangle (uncapped upside risk)", () => {
  const p: StrategyParams = { mode: "strangle", putStrike: 45, putPrem: 1.5, callStrike: 55, callPrem: 1.5, shares: 100 };
...
describe("buildModel", () => {
  ...
  it("caps spread collateral at the spread width, not the full strike", () => {
    const spread: StrategyParams = { ...base, mode: "spread", longStrike: 45, longPrem: 1, putPrem: 2 };
