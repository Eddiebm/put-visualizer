...
import { sma, rsi, atr, volumeRatio, analyzeStock, technicalGrade, technicalMarketCondition } from "./technicals.js";

function makeBars(closes, { high = null, low = null, vol = 1_000_000 } = {}) {
...
describe("analyzeStock", () => {
  it("returns null with fewer than 50 bars — not enough for the model", () => {
    expect(analyzeStock({ sym: "X", name: "X", bars: makeBars([100, 101]), capital: 1000 })).toBeNull();
  });
