...
function d1d2(spot: number, strike: number, dte: number, rate: number, vol: number) {
  const T = dte / 365;
...
export function bsPrice(spot: number, strike: number, dte: number, rate: number, vol: number, type: OptionType): number {
...
export function bsGreeks(spot: number, strike: number, dte: number, rate: number, vol: number, type: OptionType): Greeks {
  if (dte <= 0 || vol <= 0) {
...
export function solveIv(marketPrice: number, spot: number, strike: number, dte: number, rate: number, type: OptionType): number | null {
...
export function realizedVol(closes: number[] | null | undefined, window = 30): number | null {
...
export function lnDensity(S: number, S0: number, iv: number, T: number): number {
...
export function getTheoretical({ spot, strike, dte, rate = 0.05, vol, type = "put" }: TheoreticalInput): { price: number } & Greeks {
