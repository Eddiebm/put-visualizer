...
import { opportunityScore, scoreGrade, marketCondition } from "./score.js";

const goodInputs = {
  richness: { tag: "rich" }, pop: 0.85, cushion: 1.6, canAfford: true,
